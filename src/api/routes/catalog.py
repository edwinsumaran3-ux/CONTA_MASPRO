...
MASTER_CATALOG: list[dict[str, Any]] = [
    ...
    {"code":"252-EP-GE-0003-F","name":"Zapatos seguridad punta acero","cta":"252","gasto":"6564","nat":"EP","tk":"F","unit":"PAR","rubros":["GE","MI","CO","FA","AG","PE","EN","RE"],"ai_keywords":["zapatos","botas","seguridad","calzado","zapatos punta acero","botas punta acero","calzado de seguridad","zapatos de seguridad","botas seguridad industrial"],"aliases":["zapatos seguridad","botas industrial"]},
